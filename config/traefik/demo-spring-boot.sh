...
docker run --rm -it \
    ...
    --label 'traefik.http.middlewares.demo-spring-boot.redirectscheme.scheme=https' \
    --label 'traefik.http.middlewares.demo-spring-boot.redirectscheme.permanent=true' \
